...
include('../navbar.php');
// Fetch all records from the blacklisted_driver table
try {
    $sql = "SELECT id, name, aadhar_no, license_no, reason, TO_CHAR(start_date, 'YYYY-MM-DD') AS start_date, TO_CHAR(end_date, 'YYYY-MM-DD') AS end_date FROM B_D ORDER BY id";
