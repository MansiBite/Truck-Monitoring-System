...
<body>
    <h2>Select Date Range to Filter</h2>
    <!-- <form method="post">
    ...
    <h2><?php echo $start_date && $end_date ? "Filtered Data from $start_date to $end_date" : "Loading Program"; ?></h2>
    ...
    <form action=""><button type="button" onclick="goBack()">Go Back</button></form>
    <script>
        function goBack() {
            window.history.back();
        }
