...
<body>
    <div class="container">
        ...
        <form method="POST">
            <label>AREA NAME:
                <input type="text" name="AREA_NAME" value="<?php echo htmlspecialchars($area_name); ?>" required
                    readonly>
            </label>
            ...
            <label>MINE NAME:
                <select name="MINE_NAME" required onchange="this.form.submit()">
                    ...
                    foreach ($mines as $mine):
                        ?>
                        <option value="<?php echo $mine['MINE_NAME']; ?>" <?php echo (isset($_POST['MINE_NAME']) && $_POST['MINE_NAME'] == $mine['MINE_NAME']) ? 'selected' : ''; ?>>
            ...
            <label>MINE CODE:
                <input type="text" name="MINE_CODE" value="<?php echo htmlspecialchars($mine_code); ?>" required
                    readonly>
            </label>
