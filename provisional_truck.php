...
<html>
<head>
    <title>Provisional Truck No. </title>
    <style>
        body {
...
<body>
    <div class="form-container">
        <h1>Provisional Truck No.</h1>
        <form method="POST" action="../savephp/save_provisional_truck.php">
            ...
            <div id="date_fields" class="dynamic-fields">
                <h3>Schedule Details of Trucks:</h3>
            </div>
            ...
            if (dateFromInput.value) {
                ...
                for (let i = 0; i < 7; i++) {
                    ...
                    <div class="date-fields">
                        ...
                        <input type="text" id="trucks_${i}" name="trucks_${i}" placeholder="Enter Truck No." required>
                    </div>
                `;
