...
<head>
    ...
    <title>Transporter Dashboard - Coal Transporter</title>
...
<body>
    <div class="navbar">
        <h1>Transporter Dashboard - Coal Transporter</h1>
        ...
        <div class="sidebar">
            ...
            <ul class="menu">
                ...
                <li>
                    ...
                    <ul class="submenu">
                        <li><a href="?page=display-sales-orders">Display</a></li>
                    </ul>
                </li>
                <li>
                ...
                <li>
                    ...
                    <ul class="submenu">
                        <li><a href="?page=display-invoices">Display</a></li>
                    </ul>
                </li>
                <li>
                    <button class="menu-btn">Refund Details</button>
                    <ul class="submenu">
                        <li><a href="?page=display-refunds">Display</a></li>
                    </ul>
                </li>
            </ul>
        </div>
